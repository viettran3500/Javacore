...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinnerSpecialized.adapter = ArrayAdapter(this@MainActivity, android.R.layout.simple_spinner_item, list)
        ...
        buttonSearch.setOnClickListener {
            if(!edittextSearch.text.isEmpty()){
                if(radioName.isChecked()){
                    ...
                    search("year");
                }else if(radioNum.isChecked()){
                    search("num");
                }else if(radioSpecialized.isChecked()){
                    search("s");
                }
            }else {
    ...
    private fun search(str : String) {
        if(str.equals("name")){
            ...
            for(i in 0 until arrayListStudent.size){
                if(!arrayListStudent.get(i).name.toUpperCase().contains(edittextSearch.getText().toString().toUpperCase())){
        ...
        if(str.equals("year")){
            ...
            arrayListStudent4.clear();
            for(i in 0 until arrayListStudent.size){
                if(!arrayListStudent.get(i).yearOfBird.toString().toUpperCase().contains(edittextSearch.getText().toString().toUpperCase())){
                    arrayListStudent4.add(arrayListStudent.get(i));
                }
            }
            arrayListStudent.removeAll(arrayListStudent4);
        ...
        if(str.equals("num")){
            ...
            arrayListStudent4.clear();
            for(i in 0 until arrayListStudent.size){
                if(!arrayListStudent.get(i).phoneNumber.toUpperCase().contains(edittextSearch.getText().toString().toUpperCase())){
                    arrayListStudent4.add(arrayListStudent.get(i));
                }
            }
            arrayListStudent.removeAll(arrayListStudent4);
        ...
        if(str.equals("s")){
            ...
            arrayListStudent4.clear();
            for(i in 0 until arrayListStudent.size){
                if(!arrayListStudent.get(i).specialized.toUpperCase().contains(edittextSearch.getText().toString().toUpperCase())){
                    arrayListStudent4.add(arrayListStudent.get(i));
                }
            }
            arrayListStudent.removeAll(arrayListStudent4);
    ...
    private fun check() : Boolean{
        if(edittextPhoneNumber.getText().toString().isEmpty() || edittextName.getText().toString().isEmpty()
        ...
        for (i in 0 until arrayListStudent.size){
            if(arrayListStudent.get(i).phoneNumber.equals(edittextPhoneNumber.getText().toString())){
